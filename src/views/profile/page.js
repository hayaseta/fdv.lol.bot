...
import { wireNavigation, wireCopy, wireStatsResizeAutoShortLabels, setupStatsCollapse, setupExtraMetricsToggle } from "./render/interactions.js";
...
export async function renderProfileView(input, { onBack } = {}) {
  ...
  if (!mint) { errorNotice(elApp, "Token not found."); return; }
