...
function sanitizeToken(raw = {}) {
  ...
  // buySell24h: accept 0..1 or percent 0..100
  ...
  return {
    ...
    // percent values stay as percent points (e.g. 1.5 means 1.5%)
...
export async function renderProfileView(input, { onBack } = {}) {
  ...
  try {
    ...
    if (raw.error) return errorNotice(raw.error);
  } catch (e) {
